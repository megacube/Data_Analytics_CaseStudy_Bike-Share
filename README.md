...
Step 3 - Process: 
What tool are you choosing and why?
For this project, I choose RStudio to analyze so that I can practice my skill sets in R.
All the data are stored in the same format and it is very easy to load into RStudio
